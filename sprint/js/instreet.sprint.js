/*********************************************
*
* instreet.sprint.js v0.1.6
*
*	mf  实现msn图集的mouseover功能
*
*
**********************************************/
(function(window,undefined){
	   ...
	   var document = window.document,
	       ...
	       readylist=[],
		   isFirst=true,
		   appQuery=["adApp","shopApp","weiboApp","wikiApp","newsApp","weatherApp","shareApp"];
		...
		*********************************/
		...
		var config = {
					...
					callbackurl	:	prefix+"push.action",
						...
						// cssurl	: 	'http://github.ikugua.com/sprint/css/instreet.sprint.min.css',
						imih	:	300,
						imiw	:	300,
						timer   :   1000,
						width   :   250,
